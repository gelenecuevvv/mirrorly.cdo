/**
 * The source was exported with "package@version" import specifiers.
 * Vite rewrites these at runtime (see `vite.config.ts`), but TypeScript
 * still needs to understand them for editor tooling.
 */
